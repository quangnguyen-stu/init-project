...
import { usePageTitle } from '../../libs/usePageTitle'
...
export default function Login({ flash }) {
  ...
  const LoginForm = Yup.object().shape({
    email: Yup.string().email(t('VALIDATE.VALID_EMAIL')).required(t('VALIDATE.REQUIRED_EMAIL')),
    password: Yup.string()
      .required(t('VALIDATE.REQUIRED_PASSWORD'))
      .min(6, t('VALIDATE.MIN', { number: '6' })),
  })
        ...
        <Card className={classes.styledCard}>
          ...
          <div className={classes.paper}>
            ...
            <form noValidate className={classes.form} onSubmit={formik.handleSubmit}>
              ...
              <Grid container>
                <Link component={InertiaLink} href={route('password.forgot')} variant="body2">
                  Forgot password?
                </Link>
              </Grid>
            </form>
